...
\vspace{10.5cm}
	...
	\end{verbatim}
	} Used to export the input model as a .mps file.
	...
	\end{verbatim}
	} Used to export the input model as a .lp file.
	...
	\end{verbatim}
	} Used to export the solver log in a text file. There is no standard format to this file, but we suggest to use .log as its file type.
